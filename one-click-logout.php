...
Plugin URI: https://wordpress.org/plugins/one-click-logout/
Description: Logout from WordPress dashboard with a single one click.
Author: sLaNGjIs
 ...
 *
 * [One Click Logout](https://wordpress.org/plugins/one-click-logout/)
 *
 * Logging out from the WordPress dashboard with a single one click
 *
 ...
 * TODOLIST
 *
 * [to-do list and changelog](https://wordpress.org/plugins/one-click-logout/changelog/)
 *
...
<?php 
	...
	function ocl_shfl()
		{
			echo "\n<!--Plugin One Click Logout Active-->\n";
		}
	add_action( 'wp_head' , 'ocl_shfl', 0 );
	add_action( 'wp_footer' , 'ocl_shfl', 0 );
?>